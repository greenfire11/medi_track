...
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/leveldb-library.xcframework" "FirebaseFirestore/WithLeveldb" "framework" "ios-arm64_x86_64-simulator" "ios-arm64" "ios-arm64_x86_64-maccatalyst"
