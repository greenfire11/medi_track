...
class _AddScreenState extends State<AddScreen> {
  ...
  late Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      .collection('meds')
      .where('name',isGreaterThanOrEqualTo: 'a').where('name',isLessThanOrEqualTo: queryText+ '\uf8ff').snapshots(includeMetadataChanges: true);

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<Object>(
      stream: FirebaseFirestore.instance.collection('meds').where('name','>=','a'),
