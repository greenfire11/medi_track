...
class _AddScreenState extends State<AddScreen> {
  ...
  late Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      .collection('meds')
      .where('name',isGreaterThanOrEqualTo: nameController.text).where('name',isLessThanOrEqualTo: nameController.text + '\uf8ff').snapshots(includeMetadataChanges: true);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        print(snapshot.datadocs['0']['name'])
        return Scaffold(
