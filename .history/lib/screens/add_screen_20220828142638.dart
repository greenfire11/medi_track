                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (checkIfDocExists('idValue') == true) {
                          var document = await FirebaseFirestore.instance.collection(collectionPath).doc('idValue');
    ...
    print(document("name"));
                      ...
                      for (int i = 0; i < dateListTime.length; i++) {
                        ...
                        await NotificationApi.showScheduledNotification(
                          id: FirebaseFirestore.instance.collection(userid).doc('idValue').get().data()['od'],
